...
![image-20200909134847791](汇编环境配置说明.assets\image-20200909134847791.png)
...
- VirtualBox6需要开启硬件虚拟化才可以使用，如果在启动虚拟机时遇到如图的错误，则需要禁用硬件加速中硬件虚拟化/在BIOS中开启硬件虚拟化：
  - ![image-20200908125519584](汇编环境配置说明.assets\image-20200908125519584.png)
...
![image-20200908122616227](汇编环境配置说明.assets\image-20200908122616227.png)

打开虚拟机后，桌面上的test文件夹里面装着一些用于测试的汇编代码，可以直接打开其中的sln文件运行，如图所示：

![image-20200908205721741](汇编环境配置说明.assets\image-20200908205721741.png)
